...
(function($PS) {
  ...
  var liftError = function (dictThrows) {
      return function (v) {
          if (v instanceof Data_Either.Left) {
              return Control_Monad_Error_Class.throwError((dictThrows.MonadError0()).MonadThrow0())(fromThrowable(dictThrows.Throwable1())(v.value0));
          };
          if (v instanceof Data_Either.Right) {
  ...
  var errorFromThrowable = function (dictShow) {
      return new Throwable(function () {
          ...
          var $15 = Data_Show.show(dictShow);
          return function ($16) {
              return Effect_Exception.error($15($16));
          };
      })());
  };
...
(function($PS) {
  ...
  var execQuery = function (dictColsToPGHandler) {
      return function (dictGetCols) {
          return function (dictFromSQLRow) {
              return function (conn) {
                  return function (qry) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Selda_PG_Aff.query(dictColsToPGHandler)(dictGetCols)(dictFromSQLRow)(conn)(qry))(function (result) {
                          return Recipes_ErrorHandling.liftError(Recipes_ErrorHandling["throws"](Effect_Aff.monadErrorAff)(Recipes_ErrorHandling.errorFromThrowable(Database_PostgreSQL.showPGError)))(result);
                      });
                  };
              };
          };
  ...
  var connection = function __do() {
      var mode = Node_Process.lookupEnv("MODE")();
      var $3 = Data_Eq.notEq(Data_Maybe.eqMaybe(Data_Eq.eqString))(mode)(new Data_Maybe.Just("development"));
      if ($3) {
          var connectionString = Data_Functor.map(Effect.functorEffect)(Data_Maybe.fromMaybe(""))(Node_Process.lookupEnv("DATABASE_URL"))();
          var client = $foreign.newClient({
              connectionString: connectionString,
              ssl: {
                  rejectUnauthorized: false
              }
          })();
          return $foreign.connect(client)();
      };
      var database = Data_Functor.map(Effect.functorEffect)(Data_Maybe.fromMaybe("recipes"))(Node_Process.lookupEnv("DATABASE_NAME"))();
      var user = Data_Functor.map(Effect.functorEffect)(Data_Maybe.fromMaybe(""))(Node_Process.lookupEnv("DATABASE_USER"))();
      var password = Data_Functor.map(Effect.functorEffect)(Data_Maybe.fromMaybe(""))(Node_Process.lookupEnv("DATABASE_PASSWORD"))();
      var client = $foreign.newClient({
          user: user,
          database: database,
          password: password
...
(function($PS) {
  ...
  var HTTPure_Method = $PS["HTTPure.Method"];
  var Node_Process = $PS["Node.Process"];                
  var serverOptions = function __do() {
      var portStr = Node_Process.lookupEnv("PORT")();
      var hostEnv = Node_Process.lookupEnv("HOST")();
      var mode = Node_Process.lookupEnv("MODE")();
      ...
      var dist = (function () {
          var $0 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqString))(mode)(new Data_Maybe.Just("development"));
          if ($0) {
              return "./dist";
          };
          return "./release/dist";
...
(function($PS) {
  ...
  var recipes = Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Recipes_Backend_DB.connection))(function (conn) {
  ...
  var butterChickenIngredients = Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Recipes_Backend_DB.connection))(function (conn) {
      return Recipes_Backend_DB.execQuery(Selda_PG_Utils.colsToPGHandlerI()()(Heterogeneous_Folding.hfoldlRecordWithIndex()(Heterogeneous_Folding.foldlRecordCons(new Data_Symbol.IsSymbol(function () {
          return "ingredient";
      }))()(Selda_PG_Utils.tupToRec(new Data_Symbol.IsSymbol(function () {
          return "ingredient";
  ...
  var router = function (v) {
      return function (v1) {
          if (v1.path.length === 0) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString)))(v)("/index.html")))(function (contents) {
          ...
          if (v1.path.length === 1 && v1["path"][0] === "main.js") {
              return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString)))(v)("/main.js")))(function (contents) {
          ...
          if (Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(v1.path)(Recipes_API.testRoute)) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonArray(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonMaybe(Data_Argonaut_Encode_Class.encodeJsonJString))(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                  return "units";
              }))())(new Data_Symbol.IsSymbol(function () {
                  return "recipe";
              }))())(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "ingredient";
              }))())())))(butterChickenIngredients))(function (contents) {
                  return HTTPure_Response.ok(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(Data_Argonaut_Core.stringify(contents));
              });
          };
          if (Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(v1.path)(Recipes_API.recipesRoute)) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonArray(Data_Argonaut_Encode_Class.encodeJsonJString)))(recipes))(function (contents) {
                  return HTTPure_Response.ok(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(Data_Argonaut_Core.stringify(contents));
              });
          };
  ...
  var main = Effect_Aff.launchAff_(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Recipes_Backend_ServerSetup.loadEnv)(function () {
      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
          var config = Recipes_Backend_ServerSetup.serverOptions();
          var mode = Node_Process.lookupEnv("MODE")();
          ...
          return Data_Functor["void"](Effect.functorEffect)(HTTPure_Server["serve'"](config.opts)(Recipes_Backend_ServerSetup.logMiddleware(router(config.dist)))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)(startupMsg)))();
      });
  }));
  exports["router"] = router;
  exports["butterChickenIngredients"] = butterChickenIngredients;

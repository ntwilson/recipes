...
(function($PS) {
  ...
  var main = (function () {
      var serverOptions = function (hostname) {
          return function (port) {
              return {
                  hostname: hostname,
                  port: port,
      ...
      return function __do() {
          ...
          var mode = Node_Process.lookupEnv("NODE_ENV")();
          var port = Data_Maybe.fromMaybe(80)(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Int.fromString)(portStr));
          var hostname = (function () {
              var $5 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqString))(mode)(new Data_Maybe.Just("production"));
              if ($5) {
                  return "0.0.0.0";
              };
              return "localhost";
          })();
          var opts = serverOptions(hostname)(port);
          var startupMsg = Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString))))))("starting server: ")(opts.hostname)(":")(Data_Show.show(Data_Show.showInt)(port))("/");
          return Data_Functor["void"](Effect.functorEffect)(HTTPure_Server["serve'"](opts)(logMiddleware(router))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)(startupMsg)))();
      };
  })();

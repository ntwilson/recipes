...
(function($PS) {
  ...
  var connection = function (dictMonadEffect) {
      var env = (function () {
          var $7 = Effect_Class.liftEffect(dictMonadEffect);
          return function ($8) {
              return $7(Node_Process.lookupEnv($8));
          };
      })();
      return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(env("MODE"))(function (mode) {
          var $6 = Data_Eq.notEq(Data_Maybe.eqMaybe(Data_Eq.eqString))(mode)(new Data_Maybe.Just("development"));
          if ($6) {
              return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Data_Functor.map((((dictMonadEffect.Monad0()).Bind1()).Apply0()).Functor0())(Data_Maybe.fromMaybe(""))(env("DATABASE_URL")))(function (connectionString) {
                  return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Effect_Class.liftEffect(dictMonadEffect)($foreign.newClient({
                      connectionString: connectionString,
                      ssl: {
                          rejectUnauthorized: false
                      }
                  })))(function (client) {
                      return Effect_Class.liftEffect(dictMonadEffect)($foreign.connect(client));
                  });
              });
          };
          return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Data_Functor.map((((dictMonadEffect.Monad0()).Bind1()).Apply0()).Functor0())(Data_Maybe.fromMaybe("recipes"))(env("DATABASE_NAME")))(function (database) {
              return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Data_Functor.map((((dictMonadEffect.Monad0()).Bind1()).Apply0()).Functor0())(Data_Maybe.fromMaybe(""))(env("DATABASE_USER")))(function (user) {
                  return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Data_Functor.map((((dictMonadEffect.Monad0()).Bind1()).Apply0()).Functor0())(Data_Maybe.fromMaybe(""))(env("DATABASE_PASSWORD")))(function (password) {
                      return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Effect_Class.liftEffect(dictMonadEffect)($foreign.newClient({
                          user: user,
                          database: database,
                          password: password
...
(function($PS) {
  ...
  var encodeAppState = function (v) {
      ...
      throw new Error("Failed pattern match at Recipes.DataStructures (line 88, column 1 - line 88, column 49): " + [ v.constructor.name ]);
  };
      ...
      return function (allIngredients) {
          return function (item) {
              var v = function (v1) {
                  ...
                  throw new Error("Failed pattern match at Recipes.DataStructures (line 54, column 1 - line 54, column 88): " + [ allIngredients.constructor.name, item.constructor.name ]);
              };
              ...
              if ($46.length === 2) {
                  ...
                  throw new Error("Failed pattern match at Recipes.DataStructures (line 57, column 5 - line 59, column 72): " + [ v1.constructor.name ]);
              };
              return v(true);
          };
      };
  ...
  var decodeStoreItems = function (dictThrows) {
      return function (v) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at Recipes.DataStructures (line 64, column 1 - line 64, column 102): " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
  };
  var decodeAppState = function (dictThrows) {
      return function (allIngredients) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Recipes.DataStructures (line 72, column 1 - line 72, column 98): " + [ allIngredients.constructor.name, v.constructor.name ]);
          };
      };
  };
...
(function($PS) {
  ...
  var aggregateGroup = function (ingredients) {
      return Data_Foldable.intercalate(Data_List_Types.foldableNonEmptyList)(Data_Monoid.monoidString)(", ")(Data_Functor.mapFlipped(Data_List_Types.functorNonEmptyList)(Data_Functor.mapFlipped(Data_List_Types.functorNonEmptyList)(Data_List_NonEmpty.groupBy(function (a) {
          return function (b) {
              return Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqString))(a.units)(b.units);
          };
      })(Data_List_NonEmpty.sortBy(Data_Ord.comparing(Data_Maybe.ordMaybe(Data_Ord.ordString))(function (v) {
          return v.units;
      }))(ingredients)))((function () {
          var $23 = Data_NonEmpty.foldl1(Data_List_Types.foldableList)(function (a) {
              return function (b) {
                  var $9 = {};
                  for (var $10 in a) {
                      if ({}.hasOwnProperty.call(a, $10)) {
                          $9[$10] = a[$10];
                      };
                  };
                  $9.quantity = a.quantity + b.quantity;
                  return $9;
              };
          });
          var $24 = Data_Newtype.unwrap(Data_List_Types.newtypeNonEmptyList);
          return function ($25) {
              return $23($24($25));
          };
      })()))(function (v) {
  ...
  var recipesToIngredients = function (recipeIngredients) {
      return function (allIngredients) {
          return function (recipes) {
              ...
              var groupedIngredients = Data_Functor.mapFlipped(Data_List_Types.functorList)(Data_List.groupBy(function (a) {
                  return function (b) {
              ...
              var aggregatedIngredients = Data_List.mapMaybe(function (v) {
                  var v1 = Data_Foldable.find(Data_List_Types.foldableList)((function () {
                      var $26 = Data_Eq.eq(Data_Eq.eqString)(v.ingredient);
                      return function ($27) {
                          return $26((function (v2) {
                              return v2.name;
                          })($27));
                      };
                  })())(allIngredients);
...
(function($PS) {
  ...
  var doubleMap = function (dictFunctor) {
      return function (dictFunctor1) {
          var $4 = Data_Functor.map(dictFunctor);
          var $5 = Data_Functor.map(dictFunctor1);
          return function ($6) {
              return $4($5($6));
          };
      };
...
(function($PS) {
  ...
  var setState = function (state) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_DB.connection(Effect_Aff.monadEffectAff))(function (conn) {
  ...
  var getState = Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_DB.connection(Effect_Aff.monadEffectAff))(function (conn) {
  ...
  var getSerializedState = Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_DB.connection(Effect_Aff.monadEffectAff))(function (conn) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_DB.execQuery(Selda_PG_Utils.colsToPGHandlerI()()(Heterogeneous_Folding.hfoldlRecordWithIndex()(Heterogeneous_Folding.foldlRecordCons(new Data_Symbol.IsSymbol(function () {
          return "ingredients";
      }))()(Selda_PG_Utils.tupToRec(new Data_Symbol.IsSymbol(function () {
          return "ingredients";
  ...
  var allRecipes = Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_DB.connection(Effect_Aff.monadEffectAff))(function (conn) {
  ...
  var allRecipeIngredients = Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_DB.connection(Effect_Aff.monadEffectAff))(function (conn) {
  ...
  var allIngredients = Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_DB.connection(Effect_Aff.monadEffectAff))(function (conn) {
      return Data_Functor.map(Effect_Aff.functorAff)(Data_List.fromFoldable(Data_Foldable.foldableArray))(Recipes_Backend_DB.execQuery(Selda_PG_Utils.colsToPGHandlerI()()(Heterogeneous_Folding.hfoldlRecordWithIndex()(Heterogeneous_Folding.foldlRecordCons(new Data_Symbol.IsSymbol(function () {
          return "common";
      }))()(Selda_PG_Utils.tupToRec(new Data_Symbol.IsSymbol(function () {
          return "common";
              ...
              return function (v1) {
                  if (v instanceof HTTPure_Method.Get && v1.length === 0) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString)))(dist)("/index.html")))(function (contents) {
                          return HTTPure_Response["ok'"](Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(HTTPure_Headers.header("Content-Type")("text/html; charset=UTF-7"))(contents);
                      });
                  };
                          ...
                          return function (items) {
                              if (v2.checked) {
                                  return Data_List.filter((function () {
                                      var $30 = Data_Eq.notEq(Data_Eq.eqString)(v2.item.ingredient.name);
                                      return function ($31) {
                                          return $30((function (v3) {
                              ...
                              throw new Error("Failed pattern match at Recipes.Backend.Main (line 78, column 9 - line 80, column 46): " + [ v2.constructor.name, items.constructor.name ]);
                          };
                      };
                      var go = (function () {
                          var v2 = function (v3) {
                              ...
                              if ($24 instanceof Data_Either.Right) {
                                  return Control_Bind.bind(Effect_Aff.bindAff)(getState)(function (state) {
                                      ...
                                      if (state instanceof Recipes_DataStructures.CheckKitchen) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(setState(Recipes_DataStructures.CheckKitchen.create(processItem($24.value0)(state.value0))))(function () {
                                              return HTTPure_Response.noContent(Effect_Aff_Class.monadAffAff);
                                          });
                                      };
                                      ...
                                      throw new Error("Failed pattern match at Recipes.Backend.Main (line 67, column 13 - line 74, column 34): " + [ state.constructor.name ]);
                                  });
                              };
                              return v2(true);
                          };
  ...
  var main = (function () {
      ...
      var env = (function () {
          var $32 = Effect_Class.liftEffect(Effect_Aff.monadEffectAff);
          return function ($33) {
              return $32(Node_Process.lookupEnv($33));
          };
      })();

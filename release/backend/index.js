...
(function($PS) {
      ...
      return function (rqst) {
          var rtr = function (v) {
              return function (v1) {
                  ...
                  var v2 = function (v3) {
                      if (v instanceof HTTPure_Method.Post && Data_Boolean.otherwise) {
                      ...
                      if (v instanceof HTTPure_Method.Get && Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(v1)(Recipes_API.resetStateRoute)) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(setState(Recipes_DataStructures.InputRecipes.value))(function () {
                              return HTTPure_Response.ok(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)("success");
                          });
                      };
                      return HTTPure_Response.notFound(Effect_Aff_Class.monadAffAff);
                  };
                  if (v instanceof HTTPure_Method.Post) {
                      var $15 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(v1)(Recipes_API.submitRecipesRoute);
                      if ($15) {
                          var $16 = Data_Argonaut_Decode_Parser.parseJson(rqst.body);
                          if ($16 instanceof Data_Either.Right) {
                              var $17 = Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeList(Data_Argonaut_Decode_Class.decodeJsonString))($16.value0);
                              if ($17 instanceof Data_Either.Right) {
                                  return Control_Bind.bind(Effect_Aff.bindAff)(allRecipeIngredients)(function (pairings) {
                                      return Control_Bind.bind(Effect_Aff.bindAff)(allIngredients)(function (ingredients) {
                                          var groceryList = Recipes_RecipesToIngredients.recipesToIngredients(pairings)(ingredients)($17.value0);
  ...
  var main = (function () {
      ...
      var env = (function () {
          ...
          return function ($21) {
              return $20(Node_Process.lookupEnv($21));
          };
      })();

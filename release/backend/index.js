...
(function($PS) {
  ...
  var fromSQLValueInt = new FromSQLValue((function () {
      var $39 = Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Show.show(Data_List_Types.showNonEmptyList(Foreign.showForeignError)));
      return function ($40) {
          return $39(Control_Monad_Except.runExcept(Foreign.readInt($40)));
      };
  })());
...
(function($PS) {
  ...
  var submitRecipesRoute = [ "api", "submit-recipes" ];
  var submitPantryRoute = [ "api", "submit-pantry" ];
  var setUseCaseRoute = [ "api", "set-use-case" ];
  var setRecipeStepStatusRoute = [ "api", "set-recipe-status" ];
  var setItemStatusRoute = [ "api", "set-item-status" ];
  var selectRecipeRoute = [ "api", "select-recipe" ];
  var resetStateRoute = [ "api", "reset-state" ];
  var resetRecipeRoute = [ "api", "reset-recipe" ];
  var recipesWithStepsRoute = [ "api", "recipes-with-steps" ];
  var recipesRoute = [ "api", "recipes" ];         
  var ingredientsRoute = [ "api", "ingredients" ];
  var currentStateRoute = [ "api", "current-state" ];
  var addItemRoute = [ "api", "add-item" ];
  ...
  exports["resetRecipeRoute"] = resetRecipeRoute;
  exports["recipesWithStepsRoute"] = recipesWithStepsRoute;
  exports["selectRecipeRoute"] = selectRecipeRoute;
  exports["setRecipeStepStatusRoute"] = setRecipeStepStatusRoute;
  exports["setUseCaseRoute"] = setUseCaseRoute;
})(PS);
(function(exports) {
...
(function($PS) {
  ...
  var $$throw = function (dictThrows) {
      var $23 = Control_Monad_Error_Class.throwError((dictThrows.MonadError0()).MonadThrow0());
      var $24 = fromThrowable(dictThrows.Throwable1());
      return function ($25) {
          return $23($24($25));
      };
  };
  var liftError = function (dictThrows) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Recipes.ErrorHandling (line 54, column 1 - line 54, column 91): " + [ v.constructor.name ]);
      };
  };
  var errorFromThrowable = function (dictShow) {
      return new Throwable(function () {
          ...
          var $26 = Data_Show.show(dictShow);
          return function ($27) {
              return Effect_Exception.error($26($27));
          };
      })());
  };
...
(function($PS) {
  ...
  var BinExp = (function () {
      function BinExp(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      BinExp.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new BinExp(value0, value1, value2);
              };
          };
      };
      return BinExp;
  ...
  exports["ELit"] = ELit;
  exports["EBinOp"] = EBinOp;
  exports["BinExp"] = BinExp;
      ...
      return Control_Bind.bind(((dictMonadAff.MonadEffect0()).Monad0()).Bind1())(env("MODE"))(function (mode) {
          ...
          if ($7) {
              return Control_Bind.bind(((dictMonadAff.MonadEffect0()).Monad0()).Bind1())(Data_Functor.map(((((dictMonadAff.MonadEffect0()).Monad0()).Bind1()).Apply0()).Functor0())(Data_Maybe.fromMaybe(""))(env("DATABASE_URL")))(function (connectionString) {
                  return Control_Bind.bind(((dictMonadAff.MonadEffect0()).Monad0()).Bind1())(Effect_Class.liftEffect(dictMonadAff.MonadEffect0())($foreign.newClient({
...
(function($PS) {
  ...
  var decodeUseCase = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      var v = Data_Argonaut_Core.toString(json);
      if (v instanceof Data_Maybe.Just && v.value0 === "Shopping") {
          return new Data_Either.Right(Shopping.value);
      };
      if (v instanceof Data_Maybe.Just && v.value0 === "Cooking") {
          return new Data_Either.Right(Cooking.value);
      };
      if (v instanceof Data_Maybe.Just) {
          return Data_Either.Left.create(new Data_Argonaut_Decode_Error.TypeMismatch("value: 'Shopping'|'Cooking'"));
      };
      if (v instanceof Data_Maybe.Nothing) {
          return Data_Either.Left.create(new Data_Argonaut_Decode_Error.TypeMismatch("String"));
      };
      throw new Error("Failed pattern match at Recipes.DataStructures (line 72, column 21 - line 76, column 44): " + [ v.constructor.name ]);
  });
  ...
  exports["decodeUseCase"] = decodeUseCase;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Recipes.StateSerialization"] = $PS["Recipes.StateSerialization"] || {};
  var exports = $PS["Recipes.StateSerialization"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Array = $PS["Data.Array"];
  var Data_Boolean = $PS["Data.Boolean"];
  ...
  var encodeShopping = function (v) {
      if (v instanceof Recipes_DataStructures.InputRecipes) {
          return Data_Maybe.Nothing.value;
      };
      if (v instanceof Recipes_DataStructures.CheckKitchen) {
          return Data_Maybe.Just.create(encodeIngredients(v.value0)(Data_List_Types.Nil.value));
      };
      if (v instanceof Recipes_DataStructures.BuyGroceries) {
          return Data_Maybe.Just.create(encodeIngredients(v.value0)(v.value1));
      };
      throw new Error("Failed pattern match at Recipes.StateSerialization (line 115, column 1 - line 115, column 48): " + [ v.constructor.name ]);
  };
  var encodeCooking = function (v) {
      var encodeBool = function (v1) {
          if (v1) {
              return "T";
          };
          if (!v1) {
          ...
          throw new Error("Failed pattern match at Recipes.StateSerialization (line 125, column 5 - line 125, column 27): " + [ v1.constructor.name ]);
      };
      var encodeStep = function (v1) {
          return Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString))))))(encodeBool(v1.completed))("&&")(Data_Show.show(Data_Show.showInt)(v1.ordinal))("&&")(v1.description);
      };
      var encodedSteps = Data_Foldable.intercalate(Data_List_Types.foldableList)(Data_Monoid.monoidString)(";")(Data_Functor.map(Data_List_Types.functorList)(encodeStep)(v.steps));
      return Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString))))(v.recipe)("::")(encodedSteps);
  };
  var encodeAppState = function (v) {
      if (v.useCase instanceof Recipes_DataStructures.Shopping && v.shoppingState instanceof Recipes_DataStructures.InputRecipes) {
          return {
              name: "input recipes",
              ingredients: encodeShopping(v.shoppingState),
              recipeSteps: Data_Functor.map(Data_Maybe.functorMaybe)(encodeCooking)(v.cookingState)
          };
      };
      if (v.useCase instanceof Recipes_DataStructures.Shopping && v.shoppingState instanceof Recipes_DataStructures.CheckKitchen) {
          return {
              name: "check kitchen",
              ingredients: encodeShopping(v.shoppingState),
              recipeSteps: Data_Functor.map(Data_Maybe.functorMaybe)(encodeCooking)(v.cookingState)
      ...
      if (v.useCase instanceof Recipes_DataStructures.Shopping && v.shoppingState instanceof Recipes_DataStructures.BuyGroceries) {
          return {
              name: "buy groceries",
              ingredients: encodeShopping(v.shoppingState),
              recipeSteps: Data_Functor.map(Data_Maybe.functorMaybe)(encodeCooking)(v.cookingState)
      ...
      if (v.useCase instanceof Recipes_DataStructures.Cooking) {
          var name = (function () {
              if (v.shoppingState instanceof Recipes_DataStructures.InputRecipes) {
                  return "cooking(input recipes)";
              };
              if (v.shoppingState instanceof Recipes_DataStructures.CheckKitchen) {
                  return "cooking(check kitchen)";
              };
              if (v.shoppingState instanceof Recipes_DataStructures.BuyGroceries) {
                  return "cooking(buy groceries)";
              };
              throw new Error("Failed pattern match at Recipes.StateSerialization (line 139, column 12 - line 142, column 51): " + [ v.shoppingState.constructor.name ]);
          })();
          return {
              name: name,
              ingredients: encodeShopping(v.shoppingState),
      ...
      throw new Error("Failed pattern match at Recipes.StateSerialization (line 128, column 1 - line 128, column 49): " + [ v.constructor.name ]);
  };
      ...
      return function (allIngredients) {
          return function (item) {
              var v = function (v1) {
                  ...
                  throw new Error("Failed pattern match at Recipes.StateSerialization (line 28, column 1 - line 28, column 88): " + [ allIngredients.constructor.name, item.constructor.name ]);
              };
              var $72 = Data_String_Common.split(":")(item);
              if ($72.length === 2) {
                  var v1 = Data_Foldable.find(Data_List_Types.foldableList)((function () {
                      var $117 = Data_Eq.eq(Data_Eq.eqString)($72[1]);
                      return function ($118) {
                          return $117((function (v2) {
                              return v2.name;
                          })($118));
                      };
                  })())(allIngredients);
                  ...
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Recipes_ErrorHandling["throw"](dictThrows)("Unable to find the ingredient named " + $72[1]);
                  };
                  throw new Error("Failed pattern match at Recipes.StateSerialization (line 31, column 5 - line 33, column 72): " + [ v1.constructor.name ]);
              };
              return v(true);
          };
      };
          ...
          return function (v1) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  var startsWith = function (prefix) {
                      var $119 = Data_String_CodeUnits.stripPrefix(prefix);
                      return function ($120) {
                          return Data_Maybe.isJust($119($120));
                      };
                  };
                  return Data_Functor.mapFlipped((((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Bind1()).Apply0()).Functor0())(Data_Traversable.traverse(Data_Traversable.traversableArray)((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Applicative0())(decodeStoreItem(dictThrows)(v))(Data_Array.filter((function () {
                      var $121 = Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean);
                      var $122 = startsWith("CUSTOM::");
                      return function ($123) {
                          return $121($122($123));
                      };
                  })())(Data_Array.filter((function () {
                      var $124 = Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean);
                      return function ($125) {
                          return $124(Data_String_Common["null"]($125));
                      };
                  })())(Data_String_Common.split(";")(v1.value0)))))(Data_List.fromFoldable(Data_Foldable.foldableArray));
              };
              throw new Error("Failed pattern match at Recipes.StateSerialization (line 37, column 1 - line 37, column 102): " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
  };
  var decodeSteps = function (dictThrows) {
      return function (steps) {
          var decodeBool = function (v) {
              if (v === "T") {
          ...
          return Data_Traversable["for"]((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Applicative0())(Data_List_Types.traversableList)(Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_String_Common.split(";")(steps)))(function (step) {
              var v = Data_String_Common.split("&&")(step);
              var v1 = function (v2) {
                  if (v.length === 3) {
                      return Recipes_ErrorHandling["throw"](dictThrows)(Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString))))))("unrecognized completion/ordinal: '")(v[0])("'/'")(v[1])("'"));
                  };
                  return Recipes_ErrorHandling["throw"](dictThrows)(Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString))))("Invalid app state (recipe steps), expected completion, ordinal, description separated by '&&'. Got '")(step)("'"));
              };
              if (v.length === 3) {
                  var $86 = decodeBool(v[0]);
                  if ($86 instanceof Data_Maybe.Just) {
                      var $87 = Data_Int.fromString(v[1]);
  ...
  var decodeCustomItem = function (dictThrows) {
      return function (item) {
          var v = function (v1) {
              ...
              throw new Error("Failed pattern match at Recipes.StateSerialization (line 13, column 1 - line 13, column 70): " + [ item.constructor.name ]);
          };
          var $95 = Data_String_Common.split(":")(item);
          if ($95.length === 3) {
              return Control_Applicative.pure((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Applicative0())({
                  amount: "",
                  ingredient: {
                      ...
                      section: (function () {
                          ...
                          return new Data_Maybe.Just($95[2]);
                      })(),
                      common: false
                  }
              });
  ...
  var decodeCustomItems = function (dictThrows) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Recipes.StateSerialization (line 20, column 1 - line 20, column 84): " + [ v.constructor.name ]);
      };
  };
  var decodeCookingState = function (dictThrows) {
      return function (v) {
          if (v instanceof Data_Maybe.Nothing) {
              return Control_Applicative.pure((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Applicative0())(Data_Maybe.Nothing.value);
          };
          if (v instanceof Data_Maybe.Just && v.value0 === "") {
              return Control_Applicative.pure((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Applicative0())(Data_Maybe.Nothing.value);
          };
          if (v instanceof Data_Maybe.Just) {
              var v1 = Data_String_Common.split("::")(v.value0);
              if (v1.length === 2 && v1[0] === "") {
                  return Recipes_ErrorHandling["throw"](dictThrows)("Invalid AppState (Cooking state), recipe was blank");
              };
              if (v1.length === 2 && v1[1] === "") {
                  return Recipes_ErrorHandling["throw"](dictThrows)("Invalid AppState (Cooking state), steps were blank");
              };
              if (v1.length === 2) {
                  return Control_Bind.bind((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Bind1())(decodeSteps(dictThrows)(v1[1]))(function (parsedSteps) {
                      return Control_Applicative.pure((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Applicative0())(new Data_Maybe.Just({
                          recipe: v1[0],
                          steps: parsedSteps
                      }));
                  });
              };
              return Recipes_ErrorHandling["throw"](dictThrows)("Invalid AppState (Cooking state), expecting a recipe, then '::' then the steps");
          };
          throw new Error("Failed pattern match at Recipes.StateSerialization (line 65, column 1 - line 65, column 89): " + [ v.constructor.name ]);
      };
  };
      ...
      return function (allIngredients) {
          return function (v) {
              if (v.name === "input recipes") {
                  return Control_Bind.bind((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Bind1())(decodeCookingState(dictThrows)(v.recipeSteps))(function (cookingState) {
                      return Control_Applicative.pure((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Applicative0())({
                          useCase: Recipes_DataStructures.Shopping.value,
                          shoppingState: Recipes_DataStructures.InputRecipes.value,
              ...
              if (v.name === "check kitchen") {
                  return Control_Bind.bind((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Bind1())(decodeStoreItems(dictThrows)(allIngredients)(v.ingredients))(function (ingredients) {
                      return Control_Bind.bind((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Bind1())(decodeCookingState(dictThrows)(v.recipeSteps))(function (cookingState) {
                          return Control_Applicative.pure((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Applicative0())({
                              useCase: Recipes_DataStructures.Shopping.value,
                              shoppingState: new Recipes_DataStructures.CheckKitchen(ingredients),
                              cookingState: cookingState
                          });
                      });
                  });
                  ...
                  return Control_Bind.bind((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Bind1())(decodeStoreItems(dictThrows)(allIngredients)(v.ingredients))(function (ingredients) {
                      return Control_Bind.bind((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Bind1())(decodeCustomItems(dictThrows)(v.ingredients))(function (custom) {
                          return Control_Bind.bind((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Bind1())(decodeCookingState(dictThrows)(v.recipeSteps))(function (cookingState) {
                              return Control_Applicative.pure((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Applicative0())({
                                  useCase: Recipes_DataStructures.Shopping.value,
                                  shoppingState: new Recipes_DataStructures.BuyGroceries(ingredients, custom),
                                  cookingState: cookingState
                              });
                          });
                      });
              ...
              if (v.name === "cooking(input recipes)") {
                  return Control_Bind.bind((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Bind1())(decodeCookingState(dictThrows)(v.recipeSteps))(function (cookingState) {
                      return Control_Applicative.pure((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Applicative0())({
                          useCase: Recipes_DataStructures.Cooking.value,
                          shoppingState: Recipes_DataStructures.InputRecipes.value,
                          cookingState: cookingState
                      });
                  });
              };
              if (v.name === "cooking(check kitchen)") {
                  return Control_Bind.bind((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Bind1())(decodeCookingState(dictThrows)(v.recipeSteps))(function (cookingState) {
                      return Control_Bind.bind((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Bind1())(decodeStoreItems(dictThrows)(allIngredients)(v.ingredients))(function (ingredients) {
                          return Control_Applicative.pure((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Applicative0())({
                              useCase: Recipes_DataStructures.Cooking.value,
              ...
              if (v.name === "cooking(buy groceries)") {
                  return Control_Bind.bind((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Bind1())(decodeCookingState(dictThrows)(v.recipeSteps))(function (cookingState) {
                      return Control_Bind.bind((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Bind1())(decodeStoreItems(dictThrows)(allIngredients)(v.ingredients))(function (ingredients) {
                          return Control_Bind.bind((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Bind1())(decodeCustomItems(dictThrows)(v.ingredients))(function (custom) {
                              return Control_Applicative.pure((((dictThrows.MonadError0()).MonadThrow0()).Monad0()).Applicative0())({
              ...
              throw new Error("Failed pattern match at Recipes.StateSerialization (line 77, column 1 - line 77, column 98): " + [ allIngredients.constructor.name, v.constructor.name ]);
          };
      };
  };
...
(function($PS) {
  ...
  var binOp = function (op) {
      return function (v) {
          return function (v1) {
              return Selda_Col.Col(Selda_Expr.EBinOp.create(Data_Exists.mkExists(new Selda_Expr.BinExp(op, v, v1))));
          };
      };
  };
  var expEq = binOp(new Selda_Expr.Eq(Control_Category.identity(Data_Leibniz.categoryLeibniz)));                                                         
  var asc = Selda_Query_Type.Asc.value;
  exports["expEq"] = expEq;
  exports["asc"] = asc;
})(PS);
(function($PS) {
  ...
  var restrict = function (v) {
      return Selda_Query_Type.Query(Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(function (st) {
          var $55 = {};
          for (var $56 in st) {
          ...
          $55.restricts = Data_Array.cons(v)(st.restricts);
          return $55;
      }));
  };
  var orderBy = function (order) {
      return function (v) {
          return Selda_Query_Type.Query(Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(function (st) {
              ...
              $60.order = Data_Semigroup.append(Data_Semigroup.semigroupArray)(st.order)([ Data_Tuple.Tuple.create(order)(Data_Exists.mkExists(v)) ]);
              return $60;
          }));
      };
  };
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Recipes.Backend.LoadState"] = $PS["Recipes.Backend.LoadState"] || {};
  var exports = $PS["Recipes.Backend.LoadState"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_MonadZero = $PS["Control.MonadZero"];
  var Data_Array = $PS["Data.Array"];
  ...
  var Recipes_ErrorHandling = $PS["Recipes.ErrorHandling"];
  var Recipes_StateSerialization = $PS["Recipes.StateSerialization"];
  var Selda = $PS["Selda"];
  var Selda_Col = $PS["Selda.Col"];
  var Selda_PG_Utils = $PS["Selda.PG.Utils"];
  ...
  var setState = function (state) {
      return Recipes_Backend_DB.withConnection(Effect_Aff_Class.monadAffAff)(function (conn) {
          var stateRecord = Recipes_StateSerialization.encodeAppState(state);
          return Recipes_Backend_DB.execUpdate(Selda_PG_Utils.tableToColsI()(Selda_Table.tableColumnsCons(new Data_Symbol.IsSymbol(function () {
              ...
              recipeSteps: Selda_Col.lit(Selda_Col.litMaybe(Selda_Col.litString))(stateRecord.recipeSteps)
          }));
      });
  };
  var getSteps = function (recipeName) {
      return Recipes_Backend_DB.withConnection(Effect_Aff_Class.monadAffAff)(function (conn) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_DB.execQuery(Selda_PG_Utils.colsToPGHandlerI()()(Heterogeneous_Folding.hfoldlRecordWithIndex()(Heterogeneous_Folding.foldlRecordCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "stepNumber";
          })))(Heterogeneous_Folding.foldlRecordNil))))))(Database_PostgreSQL_Row.fromSQLRowTuple(Database_PostgreSQL_Value.fromSQLValueInt)(Database_PostgreSQL_Row.fromSQLRowTuple(Database_PostgreSQL_Value.fromSQLValueString)(Database_PostgreSQL_Row.fromSQLRowTupleOne(Database_PostgreSQL_Value.fromSQLValueString))))(conn)(Selda_Query.selectFrom(Selda_Query.tableToColsI()(Selda_Table.tableColumnsCons(new Data_Symbol.IsSymbol(function () {
              return "recipeName";
          }))()()()(Selda_Table.tableColumnsCons(new Data_Symbol.IsSymbol(function () {
              return "stepDescription";
          }))()()()(Selda_Table.tableColumnsCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "stepNumber";
          }))(Heterogeneous_Mapping.constMapping(Selda_Col.toColsMapping))(Heterogeneous_Mapping.mapRecordWithIndexNil)()())()())()()))))(Recipes_Backend_DB.recipeSteps)(function (step) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Selda_Query_Type.bindQuery)(Selda_Query.restrict(Selda.expEq(step.recipeName)(Selda_Col.lit(Selda_Col.litString)(recipeName))))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Selda_Query_Type.bindQuery)(Selda_Query.orderBy(Selda.asc)(step.stepNumber))(function () {
                      return Control_Applicative.pure(Selda_Query_Type.applicativeQuery)(step);
                  });
              });
          })))(function (steps) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Recipes_ErrorHandling.liftError(Recipes_ErrorHandling["throws"](Effect_Aff.monadErrorAff)(Recipes_ErrorHandling.errorFromThrowable(Data_Show.showString)))(Data_Either.note(Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString))))("No recipe steps associated with the recipe '")(recipeName)("'"))(Control_MonadZero.guard(Data_Maybe.monadZeroMaybe)(!Data_Array["null"](steps)))))(function () {
                  var cookingStateSteps = Data_Functor.mapFlipped(Data_Functor.functorArray)(steps)(function (step) {
                      return {
                          completed: false,
                  ...
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)({
                      recipe: recipeName,
                      steps: Data_List.fromFoldable(Data_Foldable.foldableArray)(cookingStateSteps)
                  });
              });
          });
      });
  ...
  var getState = Recipes_Backend_DB.withConnection(Effect_Aff_Class.monadAffAff)(function (conn) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_DB.execQuery(Selda_PG_Utils.colsToPGHandlerI()()(Heterogeneous_Folding.hfoldlRecordWithIndex()(Heterogeneous_Folding.foldlRecordCons(new Data_Symbol.IsSymbol(function () {
          ...
          return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_DB.execQuery(Selda_PG_Utils.colsToPGHandlerI()()(Heterogeneous_Folding.hfoldlRecordWithIndex()(Heterogeneous_Folding.foldlRecordCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "recipeSteps";
          })))(Heterogeneous_Folding.foldlRecordNil))))))(Database_PostgreSQL_Row.fromSQLRowTuple(Database_PostgreSQL_Value.fromSQLValueMaybe(Database_PostgreSQL_Value.fromSQLValueString))(Database_PostgreSQL_Row.fromSQLRowTuple(Database_PostgreSQL_Value.fromSQLValueString)(Database_PostgreSQL_Row.fromSQLRowTupleOne(Database_PostgreSQL_Value.fromSQLValueMaybe(Database_PostgreSQL_Value.fromSQLValueString)))))(conn)(Selda_Query.selectFrom(Selda_Query.tableToColsI()(Selda_Table.tableColumnsCons(new Data_Symbol.IsSymbol(function () {
              return "ingredients";
          }))()()()(Selda_Table.tableColumnsCons(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))()()()(Selda_Table.tableColumnsCons(new Data_Symbol.IsSymbol(function () {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_ErrorHandling.liftError(Recipes_ErrorHandling["throws"](Effect_Aff.monadErrorAff)(Recipes_ErrorHandling.errorFromThrowable(Data_Show.showString)))(Data_Either.note("No appState record found in the database")(Data_Array.head(serializedRecords))))(function (serialized) {
                  return Recipes_StateSerialization.decodeAppState(Recipes_ErrorHandling["throws"](Effect_Aff.monadErrorAff)(Recipes_ErrorHandling.errorFromThrowable(Data_Show.showString)))(Data_List.fromFoldable(Data_Foldable.foldableArray)(ingredients))(serialized);
              });
          });
      });
  });
  ...
  var getRecipesWithSteps = Recipes_Backend_DB.withConnection(Effect_Aff_Class.monadAffAff)(function (conn) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_DB.execQuery(Selda_PG_Utils.colsToPGHandlerI()()(Heterogeneous_Folding.hfoldlRecordWithIndex()(Heterogeneous_Folding.foldlRecordCons(new Data_Symbol.IsSymbol(function () {
          return "recipeName";
      }))()(Selda_PG_Utils.tupToRec(new Data_Symbol.IsSymbol(function () {
          return "recipeName";
          ...
          return "stepNumber";
      }))(Heterogeneous_Mapping.constMapping(Selda_Col.toColsMapping))(Heterogeneous_Mapping.mapRecordWithIndexNil)()())()())()()))))(Recipes_Backend_DB.recipeSteps)(function (v) {
          return Control_Applicative.pure(Selda_Query_Type.applicativeQuery)({
              recipeName: v.recipeName
          });
      })))(function (recipes) {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Array.fromFoldable(Data_Set.foldableSet)(Data_Set.fromFoldable(Data_Foldable.foldableArray)(Data_Ord.ordString)(Data_Functor.mapFlipped(Data_Functor.functorArray)(recipes)(function (v) {
              return v.recipeName;
          }))));
      });
  });
  ...
  exports["getRecipesWithSteps"] = getRecipesWithSteps;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Recipes.Backend.RecipesToIngredients"] = $PS["Recipes.Backend.RecipesToIngredients"] || {};
  var exports = $PS["Recipes.Backend.RecipesToIngredients"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Interpolate = $PS["Data.Interpolate"];
      ...
      return function (allIngredients) {
          return function (recipes) {
              ...
              var aggregatedIngredients = Data_List.mapMaybe(function (v) {
                  ...
                  throw new Error("Failed pattern match at Recipes.Backend.RecipesToIngredients (line 31, column 9 - line 33, column 55): " + [ v1.constructor.name ]);
...
(function($PS) {
  "use strict";
  $PS["Recipes.Backend.Routing"] = $PS["Recipes.Backend.Routing"] || {};
  var exports = $PS["Recipes.Backend.Routing"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Error_Class = $PS["Control.Monad.Error.Class"];
  var Data_Argonaut_Core = $PS["Data.Argonaut.Core"];
  var Data_Argonaut_Decode_Class = $PS["Data.Argonaut.Decode.Class"];
  ...
  var Recipes_Backend_LoadState = $PS["Recipes.Backend.LoadState"];
  var Recipes_Backend_RecipesToIngredients = $PS["Recipes.Backend.RecipesToIngredients"];
  var Recipes_DataStructures = $PS["Recipes.DataStructures"];
  var Shared_Prelude = $PS["Shared.Prelude"];                
  var serveStaticContent = function (contentType) {
      return function (filePath) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(filePath))(function (contents) {
              return HTTPure_Response["ok'"](Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(HTTPure_Headers.header("Content-Type")(Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString)))(contentType)("; charset=UTF-8")))(contents);
          });
      };
  };
  var serveJavascript = serveStaticContent("text/javascript");
  var serveHtml = serveStaticContent("text/html");
  var serveCss = serveStaticContent("text/css");
  var router = function (dist) {
      return function (rqst) {
          var rtr = function (v) {
              return function (v1) {
                  if (v instanceof HTTPure_Method.Get && v1.length === 0) {
                      return serveHtml(Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString)))(dist)("/index.html"));
                  };
                  if (v instanceof HTTPure_Method.Get && (v1.length === 1 && v1[0] === "index.css")) {
                      return serveCss(Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString)))(dist)("/index.css"));
                  };
                  if (v instanceof HTTPure_Method.Get && (v1.length === 1 && v1[0] === "main.js")) {
                      return serveJavascript(Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString)))(dist)("/main.js"));
                  };
                  if (v instanceof HTTPure_Method.Get && Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(v1)(Recipes_API.recipesRoute)) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonArray(Data_Argonaut_Encode_Class.encodeJsonJString)))(Recipes_Backend_LoadState.allRecipes))(function (contents) {
                  ...
                  if (v instanceof HTTPure_Method.Get && Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(v1)(Recipes_API.ingredientsRoute)) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonList(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJBoolean)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonMaybe(Data_Argonaut_Encode_Class.encodeJsonJString))(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                          ...
                          return "common";
                      }))())())))(Recipes_Backend_LoadState.allIngredients))(function (contents) {
                          return HTTPure_Response.ok(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(Data_Argonaut_Core.stringify(contents));
                      });
                  };
                  if (v instanceof HTTPure_Method.Post && Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(v1)(Recipes_API.submitRecipesRoute)) {
                      var go = (function () {
                          var v2 = function (v3) {
                              ...
                              throw new Error("Failed pattern match at Recipes.Backend.Routing (line 17, column 1 - line 17, column 57): " + [  ]);
                          };
                          var $37 = Data_Argonaut_Decode_Parser.parseJson(rqst.body);
                          if ($37 instanceof Data_Either.Right) {
                              var $38 = Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeList(Data_Argonaut_Decode_Class.decodeJsonString))($37.value0);
                              if ($38 instanceof Data_Either.Right) {
                                  return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_LoadState.allRecipeIngredients)(function (pairings) {
                                      return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_LoadState.allIngredients)(function (ingredients) {
                                          return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_LoadState.getState)(function (state) {
                                              var groceryList = Recipes_Backend_RecipesToIngredients.recipesToIngredients(pairings)(ingredients)($38.value0);
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Recipes_Backend_LoadState.setState({
                                                  useCase: Recipes_DataStructures.Shopping.value,
                                                  shoppingState: new Recipes_DataStructures.CheckKitchen(groceryList),
                  ...
                  if (v instanceof HTTPure_Method.Get && Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(v1)(Recipes_API.submitPantryRoute)) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_LoadState.getState)(function (state) {
                          if (state.useCase instanceof Recipes_DataStructures.Shopping && state.shoppingState instanceof Recipes_DataStructures.CheckKitchen) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Recipes_Backend_LoadState.setState({
                                  useCase: state.useCase,
                                  shoppingState: new Recipes_DataStructures.BuyGroceries(state.shoppingState.value0, Data_List_Types.Nil.value),
                                  cookingState: state.cookingState
                              }))(function () {
                                  return HTTPure_Response.noContent(Effect_Aff_Class.monadAffAff);
                              });
                          ...
                          return function (items) {
                              if (v2.checked) {
                                  return Data_List.filter((function () {
                                      var $100 = Data_Eq.notEq(Data_Eq.eqString)(v2.item.ingredient.name);
                                      return function ($101) {
                              ...
                              throw new Error("Failed pattern match at Recipes.Backend.Routing (line 83, column 9 - line 85, column 46): " + [ v2.constructor.name, items.constructor.name ]);
                          };
                      };
                      var go = (function () {
                          var v2 = function (v3) {
                              ...
                              if ($50 instanceof Data_Either.Right) {
                                  return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_LoadState.getState)(function (state) {
                                      if (state.useCase instanceof Recipes_DataStructures.Shopping && state.shoppingState instanceof Recipes_DataStructures.CheckKitchen) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Recipes_Backend_LoadState.setState({
                                              useCase: state.useCase,
                                              shoppingState: Recipes_DataStructures.CheckKitchen.create(processItem($50.value0)(state.shoppingState.value0)),
                                              cookingState: state.cookingState
                                          }))(function () {
                                              return HTTPure_Response.noContent(Effect_Aff_Class.monadAffAff);
                                          });
                                      };
                                      if (state.useCase instanceof Recipes_DataStructures.Shopping && state.shoppingState instanceof Recipes_DataStructures.BuyGroceries) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)((function () {
                                              if ($50.value0.isCustom) {
                                                  return Recipes_Backend_LoadState.setState({
                                                      useCase: state.useCase,
                                                      shoppingState: new Recipes_DataStructures.BuyGroceries(state.shoppingState.value0, processItem($50.value0)(state.shoppingState.value1)),
                                                      cookingState: state.cookingState
                                                  });
                                              };
                                              return Recipes_Backend_LoadState.setState({
                                                  useCase: state.useCase,
                                                  shoppingState: new Recipes_DataStructures.BuyGroceries(processItem($50.value0)(state.shoppingState.value0), state.shoppingState.value1),
                                                  cookingState: state.cookingState
                                              });
                                          })())(function () {
                                              return HTTPure_Response.noContent(Effect_Aff_Class.monadAffAff);
                              ...
                              return function (newCustom) {
                                  var sameSection = function (custSection) {
                                      return function (v2) {
                                          ...
                                          throw new Error("Failed pattern match at Recipes.Backend.Routing (line 118, column 13 - line 118, column 65): " + [ custSection.constructor.name, v2.constructor.name ]);
                                      };
                                  };
                                  ...
                                  var correctedSection = (function () {
                                      ...
                                      var v2 = function (v3) {
                                          ...
                                          throw new Error("Failed pattern match at Recipes.Backend.Routing (line 17, column 1 - line 17, column 57): " + [ newCustom.section.constructor.name ]);
                                      };
                                      if (newCustom.section instanceof Data_Maybe.Just) {
                                          var $71 = Data_Foldable.findMap(Data_List_Types.foldableList)(sameSection(newCustom.section.value0))(allExisting);
                                  ...
                                  var correctedStore = (function () {
                                      ...
                                      throw new Error("Failed pattern match at Recipes.Backend.Routing (line 108, column 30 - line 110, column 41): " + [ v2.constructor.name ]);
                                  })();
                                  return {
                                      name: newCustom.name,
                              ...
                              if ($79 instanceof Data_Either.Right) {
                                  return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_LoadState.getState)(function (state) {
                                      if (state.useCase instanceof Recipes_DataStructures.Shopping && state.shoppingState instanceof Recipes_DataStructures.BuyGroceries) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Recipes_Backend_LoadState.setState({
                                              useCase: state.useCase,
                                              shoppingState: new Recipes_DataStructures.BuyGroceries(state.shoppingState.value0, addItem($79.value0)(state.shoppingState.value0)(state.shoppingState.value1)),
                                              cookingState: state.cookingState
                                          }))(function () {
                                              return HTTPure_Response.noContent(Effect_Aff_Class.monadAffAff);
                                          });
                  ...
                  if (v instanceof HTTPure_Method.Get && Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(v1)(Recipes_API.resetRecipeRoute)) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_LoadState.getState)(function (state) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Recipes_Backend_LoadState.setState({
                              useCase: state.useCase,
                              shoppingState: state.shoppingState,
                              cookingState: Data_Maybe.Nothing.value
                          }))(function () {
                              return HTTPure_Response.noContent(Effect_Aff_Class.monadAffAff);
                          });
                      });
                  };
                  if (v instanceof HTTPure_Method.Post && Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(v1)(Recipes_API.setRecipeStepStatusRoute)) {
                      var replaceStep = function (newStep) {
                          return function (steps) {
                              return Data_Functor.mapFlipped(Data_List_Types.functorList)(steps)(function (step) {
                                  var $87 = step.ordinal === newStep.ordinal;
                                  if ($87) {
                                      return newStep;
                                  };
                                  return step;
                      ...
                      var go = (function () {
                          var v2 = function (v3) {
                              if (Data_Boolean.otherwise) {
                                  return HTTPure_Response.badRequest(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString)))("Could not parse request body: ")(rqst.body));
                              };
                              throw new Error("Failed pattern match at Recipes.Backend.Routing (line 17, column 1 - line 17, column 57): " + [  ]);
                          };
                          var $88 = Data_Argonaut_Decode_Parser.parseJson(rqst.body);
                          if ($88 instanceof Data_Either.Right) {
                              var $89 = Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonBoolean)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                                  return "ordinal";
                              }))()())(new Data_Symbol.IsSymbol(function () {
                                  return "description";
                              }))()())(new Data_Symbol.IsSymbol(function () {
                              ...
                              if ($89 instanceof Data_Either.Right) {
                                  return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_LoadState.getState)(function (state) {
                                      if (state.cookingState instanceof Data_Maybe.Nothing) {
                                          return HTTPure_Response.conflict(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)("The application is not in a state such that modifying recipe steps is possible.");
                                      };
                                      if (state.cookingState instanceof Data_Maybe.Just) {
                                          var $91 = !Data_Foldable.any(Data_List_Types.foldableList)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (s) {
                                              return s.ordinal === $89.value0.ordinal;
                                          })(state.cookingState.value0.steps);
                                          if ($91) {
                                              return HTTPure_Response.badRequest(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString)))("Could not find step with ordinal: ")(Data_Show.show(Data_Show.showInt)($89.value0.ordinal)));
                                          };
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Recipes_Backend_LoadState.setState({
                                              useCase: state.useCase,
                                              shoppingState: state.shoppingState,
                                              cookingState: Data_Maybe.Just.create({
                                                  steps: replaceStep($89.value0)(state.cookingState.value0.steps),
                                                  recipe: state.cookingState.value0.recipe
                                              })
                                          }))(function () {
                                              return HTTPure_Response.noContent(Effect_Aff_Class.monadAffAff);
                                          });
                                      };
                                      throw new Error("Failed pattern match at Recipes.Backend.Routing (line 136, column 13 - line 143, column 36): " + [ state.cookingState.constructor.name ]);
                                  });
                              };
                              return v2(true);
                          };
                  ...
                  if (v instanceof HTTPure_Method.Get && Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(v1)(Recipes_API.recipesWithStepsRoute)) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_LoadState.getRecipesWithSteps)(function (recipes) {
                          return HTTPure_Response.ok(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(Data_Argonaut_Core.stringify(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonArray(Data_Argonaut_Encode_Class.encodeJsonJString))(recipes)));
                      });
                  };
                  if (v instanceof HTTPure_Method.Post && Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(v1)(Recipes_API.selectRecipeRoute)) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_LoadState.getState)(function (state) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_LoadState.getSteps(rqst.body))(function (steps) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Recipes_Backend_LoadState.setState({
                                  useCase: Recipes_DataStructures.Cooking.value,
                                  shoppingState: state.shoppingState,
                                  cookingState: new Data_Maybe.Just(steps)
                              }))(function () {
                                  return HTTPure_Response.noContent(Effect_Aff_Class.monadAffAff);
                              });
                          });
                  ...
                  if (v instanceof HTTPure_Method.Post && Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(v1)(Recipes_API.setUseCaseRoute)) {
                      var go = (function () {
                          var v2 = function (v3) {
                              if (Data_Boolean.otherwise) {
                                  return HTTPure_Response.badRequest(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString)))("Could not parse request body: ")(rqst.body));
                          ...
                          var $96 = Data_Argonaut_Decode_Parser.parseJson(rqst.body);
                          if ($96 instanceof Data_Either.Right) {
                              var $97 = Data_Argonaut_Decode_Class.decodeJson(Recipes_DataStructures.decodeUseCase)($96.value0);
                              if ($97 instanceof Data_Either.Right) {
                                  return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_LoadState.getState)(function (state) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Recipes_Backend_LoadState.setState({
                                          useCase: $97.value0,
                                          shoppingState: state.shoppingState,
...
(function($PS) {
  ...
  var Node_Process = $PS["Node.Process"];
  var Recipes_Backend_Routing = $PS["Recipes.Backend.Routing"];
  ...
  var main = (function () {
      ...
      var env = (function () {
          ...
          return function ($1) {
              return $0(Node_Process.lookupEnv($1));
          };
      })();
      return Effect_Aff.launchAff_(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Recipes_Backend_ServerSetup.loadEnv)(function () {
          return Control_Bind.bind(Effect_Aff.bindAff)(Recipes_Backend_ServerSetup.serverOptions(Effect_Aff.monadEffectAff))(function (config) {
              return Control_Bind.bind(Effect_Aff.bindAff)(env("MODE"))(function (mode) {
                  ...
                  return serve(config.opts)(Recipes_Backend_ServerSetup.logMiddleware(Recipes_Backend_Routing.router(config.dist)))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)(startupMsg));
              });
          });
      }));
  })();

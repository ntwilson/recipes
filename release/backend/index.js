...
(function($PS) {
  ...
  var connection = function __do() {
      ...
      var $0 = Data_Eq.notEq(Data_Maybe.eqMaybe(Data_Eq.eqString))(mode)(new Data_Maybe.Just("development"));
      if ($0) {
...
(function($PS) {
  ...
  var butterChickenIngredients = Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Recipes_Backend_DB.connection))(function (conn) {
      return Selda_PG_Aff.query(Selda_PG_Utils.colsToPGHandlerI()()(Heterogeneous_Folding.hfoldlRecordWithIndex()(Heterogeneous_Folding.foldlRecordCons(new Data_Symbol.IsSymbol(function () {
          return "ingredient";
  ...
  var router = function (v) {
      return function (v1) {
          ...
          if (v1.path.length === 2 && (v1["path"][0] === "api" && v1["path"][1] === "test")) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_Show.show(Data_Either.showEither(Database_PostgreSQL.showPGError)(Data_Show.showArray(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "ingredient";
              }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "quantity";
              }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "units";
              }))(Data_Show.showRecordFieldsNil)(Data_Maybe.showMaybe(Data_Show.showString)))(Data_Show.showString))(Data_Show.showNumber))(Data_Show.showString))))))(butterChickenIngredients))(function (contents) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)(Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString)))("responding with ")(contents)))(function () {
                      return HTTPure_Response.ok(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(contents);
                  });
              });
          };
  ...
  var main = Effect_Aff.launchAff_(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Recipes_Backend_ServerSetup.loadEnv)(function () {
      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
          var opts = Recipes_Backend_ServerSetup.serverOptions();
          var mode = Node_Process.lookupEnv("MODE")();
          ...
          var startupMsg = Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString)))))))("starting server: ")(opts.hostname)(":")(Data_Show.show(Data_Show.showInt)(opts.port))("/")(startupSuffix);
          var dist = (function () {
              var $10 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqString))(mode)(new Data_Maybe.Just("development"));
              if ($10) {
                  return "./dist";
              };
              return "./release/dist";
          })();
          return Data_Functor["void"](Effect.functorEffect)(HTTPure_Server["serve'"](opts)(Recipes_Backend_ServerSetup.logMiddleware(router(dist)))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)(startupMsg)))();
      });
  }));

...
(function($PS) {
  ...
  var main = Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Dotenv.loadFile)(function () {
      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
          ...
          var startupMsg = Data_Interpolate.i(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpStringFunction(Data_Interpolate.interpString))))))("starting server: ")(serverOptions.hostname)(":")(Data_Show.show(Data_Show.showInt)(port))("/");
          return Data_Functor["void"](Effect.functorEffect)(HTTPure_Server["serve'"](serverOptions)(logMiddleware(router))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)(startupMsg)))();
      });
  }));
